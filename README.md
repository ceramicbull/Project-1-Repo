...
- Analyze round 1
  - To answer the first set of questions, the prime rate was compared to the average mortgage rate and the avergage mortgage rate was compared to list price, sales         price and inventory in a scatterplot. A correlation coefficient (R-value) was calculated and line graphs were created to visualize these comparisons and determine     and correlations. 
- Adjust scope
  ...
  - List price and sales price were to be analyzed to discover and trends between the two in the five year time span
...
- Analyze Round 2
  ...
  - A multi-line graph was created to compare list price and sales price
  ...
  - Multi-line graphs were created to look at the top 25 inventory markets with respect to relevant dates to visualize 
...
- Further Considerations
  - Looking more closely at significant dates in the last five years with respect to home inventory, list and sales price and prime loan and average mortgage rates could result in a causal analysis with a high degree of confidence. 
...
![MedianPricePolynomial](https://github.com/ceramicbull/Project-1-Repo/blob/main/chelsea-pickett/Resources/MortgageRatevsMedianPricePolynomial.1.png)
